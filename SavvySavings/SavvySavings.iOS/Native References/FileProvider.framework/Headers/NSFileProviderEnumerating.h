...
- (void)currentSyncAnchorWithCompletion:(void(^)(_Nullable NSFileProviderSyncAnchor currentAnchor))completion API_DEPRECATED_WITH_REPLACEMENT("currentSyncAnchorWithCompletionHandler:", ios(11.0, 11.0), macos(10.13, 10.13));
