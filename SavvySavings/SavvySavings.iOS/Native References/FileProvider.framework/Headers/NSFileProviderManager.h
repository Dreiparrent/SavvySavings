...
/*
 Deprecated methods
 */
+ (void)addDomain:(NSFileProviderDomain *)domain completion:(void(^)(NSError *_Nullable))completion API_DEPRECATED_WITH_REPLACEMENT("addDomain:completionHandler:", macos(10.13, 10.13), ios(11.0, 11.0));
+ (void)removeDomain:(NSFileProviderDomain *)domain completion:(void(^)(NSError *_Nullable))completion API_DEPRECATED_WITH_REPLACEMENT("removeDomain:completionHandler:", macos(10.13, 10.13), ios(11.0, 11.0));
- (void)signalEnumeratorForContainerItemIdentifier:(NSFileProviderItemIdentifier)containerItemIdentifier  API_DEPRECATED_WITH_REPLACEMENT("signalEnumeratorForContainerItemIdentifier:completionHandler:", macos(10.13, 10.13), ios(11.0, 11.0));
- (void)registerURLSessionTask:(NSURLSessionTask *)task forItemWithIdentifier:(NSFileProviderItemIdentifier)identifier API_DEPRECATED_WITH_REPLACEMENT("registerURLSessionTask:forItemWithIdentifier:completionHandler:", macos(10.13, 10.13), ios(11.0, 11.0));
